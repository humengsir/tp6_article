...
abstract class BaseController
{
    ...
    protected function checkAccess(array $node_list = [])
    {
        ...
        $active_menu_node_id = 0;
        if ($access_node_id) {
            $access_node_menu_info = get_node_menu_by_node_id($access_node_id);
            $active_menu_node_id = $access_node_menu_info['id'];
        }
        View::assign('active_menu_node_id', $active_menu_node_id);
    }
