...
CREATE TABLE `article` (
  ...
  `update_time` int unsigned NOT NULL DEFAULT '0' COMMENT '最后编辑时间',
...
INSERT INTO category (id, cat_name) VALUES(1, '要闻');
INSERT INTO category (id, cat_name) VALUES(2, '北京');
INSERT INTO category (id, cat_name) VALUES(3, '娱乐');
INSERT INTO category (id, cat_name) VALUES(4, '体育');
INSERT INTO category (id, cat_name) VALUES(5, '军事');
INSERT INTO category (id, cat_name) VALUES(6, '国际');
INSERT INTO category (id, cat_name) VALUES(7, 'NBA');
INSERT INTO category (id, cat_name) VALUES(8, '科技');
INSERT INTO category (id, cat_name) VALUES(9, '财经');
INSERT INTO category (id, cat_name) VALUES(10, '汽车');
INSERT INTO category (id, cat_name) VALUES(11, '时尚');
INSERT INTO category (id, cat_name) VALUES(12, '游戏');
...
INSERT INTO group_node (id, group_id, node_id) VALUES(28, 1, 28);
INSERT INTO group_node (id, group_id, node_id) VALUES(29, 1, 29);
INSERT INTO group_node (id, group_id, node_id) VALUES(30, 1, 30);
INSERT INTO group_node (id, group_id, node_id) VALUES(31, 1, 31);
INSERT INTO group_node (id, group_id, node_id) VALUES(32, 1, 32);
INSERT INTO group_node (id, group_id, node_id) VALUES(33, 1, 33);
INSERT INTO group_node (id, group_id, node_id) VALUES(34, 1, 34);
INSERT INTO group_node (id, group_id, node_id) VALUES(35, 1, 35);
...
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(29, '添加会议室', 23, 1, 498, 27);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(30, '编辑会议室', 24, 0, 497, 27);
...
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(34, '内容管理', 0, 0, 450, 0);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(35, '分类列表', 28, 1, 449, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(36, '添加分类', 29, 0, 448, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(37, '编辑分类', 30, 0, 447, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(38, '删除分类', 31, 0, 446, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(39, '文章列表', 32, 1, 445, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(40, '添加文章', 33, 0, 444, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(41, '编辑文章', 34, 0, 443, 34);
INSERT INTO menu (id, menu_name, node_id, is_nav, menu_sort, pid) VALUES(42, '删除文章', 35, 0, 442, 34);
...
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(28, '分类列表', '/category/index', 450, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(29, '分类添加', '/category/add', 449, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(30, '分类编辑', '/category/edit', 448, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(31, '分类删除', '/category/del', 447, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(32, '文章列表', '/article/index', 440, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(33, '文章添加', '/article/add', 439, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(34, '文章编辑', '/article/edit', 438, 7, 1);
INSERT INTO node (id, node_name, node_url, node_sort, node_type, status) VALUES(35, '文章删除', '/article/del', 437, 7, 1);
...
INSERT INTO room (id, room_name, lock_start_time, lock_end_time, room_people_num, status) VALUES(1, '中心会议室', 0, 0, 31, 1);
...
INSERT INTO `user` (id, username, password, email, status) VALUES(1, 'admin', 'f3970736977b4794bc75f1ef8291b376', 'admin@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(2, '任晨骆', '59bb8c33a1f5627f6dcf8d582619dcdf', 'renchenluo@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(3, '窦恒翰', '59bb8c33a1f5627f6dcf8d582619dcdf', 'douhenhan@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(4, '尚管思', '59bb8c33a1f5627f6dcf8d582619dcdf', 'shangguansi@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(5, '姬翰育', '59bb8c33a1f5627f6dcf8d582619dcdf', 'jihanyu@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(6, '彭姣顺', '59bb8c33a1f5627f6dcf8d582619dcdf', 'pengjiaoshun@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(7, '潘心颖', '59bb8c33a1f5627f6dcf8d582619dcdf', 'panxinying@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(8, '储庄言', '59bb8c33a1f5627f6dcf8d582619dcdf', 'chuzhuangyan@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(9, '姚雨芳', '59bb8c33a1f5627f6dcf8d582619dcdf', 'yaoyufang@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(10, '冉泰浩', '59bb8c33a1f5627f6dcf8d582619dcdf', 'rantaihao@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(11, '袁维梅', '59bb8c33a1f5627f6dcf8d582619dcdf', 'yuanweimei@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(12, '林索', '59bb8c33a1f5627f6dcf8d582619dcdf', 'linsuo@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(13, '林方豪', '59bb8c33a1f5627f6dcf8d582619dcdf', 'linwenhao@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(14, '江心冉', '59bb8c33a1f5627f6dcf8d582619dcdf', 'jiangxinran@article.com', 1);
INSERT INTO `user` (id, username, password, email, status) VALUES(15, '廖文芳', '59bb8c33a1f5627f6dcf8d582619dcdf', 'liaowenfang@article.com', 1);
